...
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/iemsoptionsprice2/ && composer dump-autoload
/**
 * MODx IeMsOptionsPrice2 Class
 *
 * @package msimportexport
 */
class IeMsOptionsPrice2
{
    const version = '1.0.0';
    /** @var modX $modx */
    public $modx;
    ...
    public $config = array();
    /** @var string */
    public $namespace = 'iemsoptionsprice2';
     ...
     * @return IeMsOptionsPrice2
     */
    function __construct(modX &$modx, array $config = array())
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('iemsoptionsprice2.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/iemsoptionsprice2/');
        $assetsUrl = $this->modx->getOption('iemsoptionsprice2.assets_url', $config, $this->modx->getOption('assets_url') . 'components/iemsoptionsprice2/');
        $assetsPath = $this->modx->getOption('iemsoptionsprice2.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/iemsoptionsprice2/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('iemsoptionsprice2_tools_handler_class', null, 'IeMsOptionsPrice2Tools'),
        ), $config);

        $this->modx->lexicon->load('iemsoptionsprice2:default');
        $this->modx->addPackage('iemsoptionsprice2', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/iemsoptionsprice2/processors/';
