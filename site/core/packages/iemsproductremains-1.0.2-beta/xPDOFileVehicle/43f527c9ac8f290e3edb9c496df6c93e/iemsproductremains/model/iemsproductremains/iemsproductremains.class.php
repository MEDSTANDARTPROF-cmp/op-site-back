...
// If you need to update the autoloader because of new classes in a classmap package
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/iemsproductremains/ && composer dump-autoload
/**
 * MODx IeMsProductRemains Class
 *
 * @package msimportexport
 */
class IeMsProductRemains
{
    const version = '1.0.0';
    /** @var modX $modx */
    public $modx;
    ...
    public $config = array();
    /** @var string */
    public $namespace = 'iemsproductremains';
     ...
     * @return IeMsProductRemains
     */
    function __construct(modX &$modx, array $config = array())
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('iemsproductremains.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/iemsproductremains/');
        $assetsUrl = $this->modx->getOption('iemsproductremains.assets_url', $config, $this->modx->getOption('assets_url') . 'components/iemsproductremains/');
        $assetsPath = $this->modx->getOption('iemsproductremains.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/iemsproductremains/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('iemsproductremains_tools_handler_class', null, 'IeMsProductRemainsTools'),
        ), $config);

        $this->modx->lexicon->load('iemsproductremains:default');
        $this->modx->addPackage('iemsproductremains', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/iemsproductremains/processors/';
    ...
    /**
     * @param array $config
     * @return IeMsProductRemainsTools
     */
