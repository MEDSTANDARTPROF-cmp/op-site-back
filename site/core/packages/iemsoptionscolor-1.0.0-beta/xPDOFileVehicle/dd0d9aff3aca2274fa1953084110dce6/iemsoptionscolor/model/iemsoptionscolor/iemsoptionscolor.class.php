...
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/iemsoptionscolor/ && composer dump-autoload
/**
 * MODx IeMsOptionsColor Class
 *
 * @package msimportexport
 */
class IeMsOptionsColor
{
    const version = '1.0.0';
    /** @var modX $modx */
    public $modx;
    ...
    public $config = array();
    /** @var string */
    public $namespace = 'iemsoptionscolor';
     ...
     * @return IeMsOptionsColor
     */
    function __construct(modX &$modx, array $config = array())
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('iemsoptionscolor.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/iemsoptionscolor/');
        $assetsUrl = $this->modx->getOption('iemsoptionscolor.assets_url', $config, $this->modx->getOption('assets_url') . 'components/iemsoptionscolor/');
        $assetsPath = $this->modx->getOption('iemsoptionscolor.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/iemsoptionscolor/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('iemsoptionscolor_tools_handler_class', null, 'IeMsOptionsColorTools'),
        ), $config);

        $this->modx->lexicon->load('iemsoptionscolor:default');
        $this->modx->addPackage('iemsoptionscolor', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/iemsoptionscolor/processors/';
