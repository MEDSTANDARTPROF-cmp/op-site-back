...
<div style="background-color: #33528D !important;">
        ...
        <div class="container position-relative ">
           <div class="row g-0">
                <div class="col-12 col-md-6 my-4 py-5 pe-5 bg-blur-offer">
                    [[*offerMarker0]]
                    <p class="lh-1 text-primary text-uppercase"><b>Готовые курсы</b><br>дополнительного образования</p>
    ...
    color: #06ae1f;
"> <img src="assets/images/temp/ic-mess-32.svg" width="32" height="32" alt="Консультация с менеджером" class="" style="filter: brightness(1.5);"><span>Получить подробности</span></a>
