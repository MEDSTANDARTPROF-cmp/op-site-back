                ...
                <div class="g-0 px-4 px-sm-5 px-6 row pb-5">
                    <div class="bg-white col-12 g-0 overflow-hidden rounded-4 row shadow">
                        ...
                        <div class="col-12 col-md-7 p-4 p-sm-5">
                            [[*cont2]]
                            <a onclick="ym(75081295,'reachGoal','zayavka')" href="#" class="btn btn-gr-l btn-ic mt-4 py-2 w-100 b24-form-marker" data-bs-toggle="modal" data-marker="Записаться о курсе" data-bs-target="#MdGl"><img src="assets/images/temp/ic-mess-32.svg" width="32" height="32" alt="Записаться на курс"><span>Записаться на курс</span></a>
                        </div>
                    </div>
                </div>
            </div>
