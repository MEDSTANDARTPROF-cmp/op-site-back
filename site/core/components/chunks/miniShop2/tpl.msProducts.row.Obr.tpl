                    ...
                    <div class="align-items-center d-flex justify-content-between">
                        <div class="">
                            [[#[[+parent]].priceOld:isnotempty=`
                                <span class="fs-18 fw-7 mу-2 text-danger">[[#[[+parent]].priceAll]]</span>
                                <span class="fs-18 fw-5 ml-md-3  price text-decoration-line-through"> [[#[[+parent]].priceOld]] ₽ </span>
                            `:else=``]]
                          
                        
                            <span class="fs-18 fw-5 ml-md-3  price [[#[[+parent]].priceOld:isnotempty=`d-none`:else=``]]">[[+price]] ₽</span>
