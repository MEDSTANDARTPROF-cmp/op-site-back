<div class="rounded-4 shadow overflow-hidden mt-5 p-4 p-sm-5 text-center" style="background: linear-gradient(135deg, #33D27B 0%, #28a964 100%);">
    <div class="py-3">
        <div class="badge bg-white text-success rounded-pill px-3 py-2 mb-3 fw-6 fs-14"><span class="bi bi-lightning-fill me-1"></span>Набор открыт</div>
        <h3 class="fw-8 h4 mb-2 text-white text-uppercase">Начните обучение уже сегодня</h3>
