...
// cd /home/modxstore/web/dev.modxstore.net/public_html/core/components/iemssaleprice/ && composer dump-autoload
/**
 * MODx IeMsSalePrice Class
 *
...
class IeMsSalePrice
{
    ...
    public $config = array();
    /** @var string */
    public $namespace = 'iemssaleprice';
     ...
     * @return IeMsSalePrice
     */
    function __construct(modX &$modx, array $config = array())
    {
        $this->modx =& $modx;
        $corePath = $this->modx->getOption('iemssaleprice.core_path', $config, $this->modx->getOption('core_path', null, MODX_CORE_PATH) . 'components/iemssaleprice/');
        $assetsUrl = $this->modx->getOption('iemssaleprice.assets_url', $config, $this->modx->getOption('assets_url') . 'components/iemssaleprice/');
        $assetsPath = $this->modx->getOption('iemssaleprice.assets_path', $config, $this->modx->getOption('assets_path', null, MODX_ASSETS_PATH) . 'components/iemssaleprice/');
        ...
        $this->config = array_merge(array(
            ...
            'toolsHandler' => $this->modx->getOption('iemssaleprice_tools_handler_class', null, 'IeMsSalePriceTools'),
        ), $config);

        $this->modx->lexicon->load('iemssaleprice:default');
        $this->modx->addPackage('iemssaleprice', $this->config['modelPath']);
    ...
    public function runProcessor($action = '', $data = array())
    {
        ...
        $processorsPath = !empty($this->config['processorsPath'])
            ...
            : MODX_CORE_PATH . 'components/iemssaleprice/processors/';
