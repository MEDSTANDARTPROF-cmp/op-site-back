                                ...
                                <div class="col-12 col-md-8">
                                    ...
                                    <div class="bg-body bg-body-secondary  rounded-4 shadow">
                                        ...
                                        <div class="px-4 px-md-5 pt-4 pt-md-5 ">
                                            <p>
                                                <span class="px-3 py-1 rounded-3 text-bg-primary">Тренажер</span>  
                                            </p>  
                                        ...
                                        <div class="px-4 px-md-5 py-4 py-md-5 d-none">
                                             <p>
                                                <a href="[[~[[getResourceField? 
                                                    &id=`[[*parent]]`
                                                    &field=`tv.testParent`
                                                ]]]]" class="btn btn-gr w-100">Посмотреть готовые ответы на тест</a>
                                            </p>
                                            [[*content]]
                                        </div>
                                    </div>
